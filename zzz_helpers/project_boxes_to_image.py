...
def get_image_points(K, E, box_3d):
    ...
    # normalize first and secon dimension and keep third dimension
    depth = image_points[2]
    image_points = image_points[:2] / image_points[2]
    image_points = np.vstack([image_points, depth])
...
if __name__ == '__main__':
    yaml_path = '/home/jeremias/TV2VD/TV2VD/dataset_generation/post-processing/data/000069/000069.yaml'
    rgb_path = '/home/jeremias/TV2VD/TV2VD/dataset_generation/post-processing/data/000069/rgb.png'
