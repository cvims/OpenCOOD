...
class TemporalPointPillarLoss(nn.Module):
    def __init__(self, args):
        super(TemporalPointPillarLoss, self).__init__()
        ...
        self.temporal_cls_weight = args['temporal_cls_weight']
        self.temporal_reg_coe = args['temporal_reg']

        self.loss_dict = {}

    def forward(self, output_dict, target_dict, temporal_target_dict):
        """
        Parameters
        ----------
        output_dict : dict
        ...
        # standard
        # normalize with all the positives including temporal ones
        ...
        # temporal
        temp_cls_targets = temp_box_cls_labels
        temp_cls_targets = temp_cls_targets.unsqueeze(dim=-1)
